  ...
  return (
    <div className="min-h-screen bg-white text-primary">
      ...
      <header className="py-20 px-6 text-center relative overflow-hidden">
        ...
        <h2 className="text-black font-lora text-sm tracking-[0.3em] uppercase mb-4">
          The Builders
        </h2>
        <h1 className="text-5xl md:text-7xl font-extrabold font-lora tracking-tight mb-6">
          Meet the <span className="font-lora text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">Dev Team</span>
        </h1>
        <p className="max-w-2xl mx-auto text-gray-500 text-lg md:text-xl leading-relaxed">
          The developers, dreamers, and coffee-fueled programmers turning complex 
