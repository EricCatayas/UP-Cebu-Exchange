export const sample_artworks = [
  {
    ...
    images: [
      {
        id: 1,
        isPrimary: true,
        imageUrl: 'https://unlimitedworks.blob.core.windows.net/up-cebu-exchange/placeholder-img-4x3.png',
      },
      {
        id: 16,
        isPrimary: false,
    ...
    style: 'impressionism',
    rentalPlans: [
      { durationMonths: 3, price: 1500.0 },
      { durationMonths: 6, price: 2800.0 },
      { durationMonths: 12, price: 5000.0 },
    ],
    status: 'available',
  ...
  },
  {
    ...
    images: [
      {
        id: 2,
        isPrimary: true,
        imageUrl: 'https://unlimitedworks.blob.core.windows.net/up-cebu-exchange/placeholder-img-3x2.png',
      },
      {
        id: 17,
        isPrimary: false,
    ...
    style: 'abstract',
    rentalPlans: [
      { durationMonths: 3, price: 2000.0 },
      { durationMonths: 6, price: 3700.0 },
      { durationMonths: 12, price: 6800.0 },
    ],
    status: 'available',
    ...
    images: [
      {
        id: 3,
        isPrimary: true,
        imageUrl: 'https://unlimitedworks.blob.core.windows.net/up-cebu-exchange/placeholder-img-2x1.png',
      },
    ],
    tags: ['banaue', 'rice terraces', 'landscape', 'heritage'],
    style: 'realism',
    rentalPlans: [
      { durationMonths: 3, price: 1200.0 },
      { durationMonths: 6, price: 2200.0 },
      { durationMonths: 12, price: 4000.0 },
    ],
    status: 'available',
  ...
  },
  {
    ...
    images: [
      {
        id: 4,
        isPrimary: true,
        imageUrl: 'https://unlimitedworks.blob.core.windows.net/up-cebu-exchange/placeholder-img-4x5.png',
      },
      {
        id: 19,
        isPrimary: false,
    ...
    style: 'contemporary',
    rentalPlans: [
      { durationMonths: 3, price: 2500.0 },
      { durationMonths: 6, price: 4600.0 },
      { durationMonths: 12, price: 8500.0 },
    ],
    status: 'available',
    ...
    images: [
      {
        id: 5,
        isPrimary: true,
        imageUrl: 'https://unlimitedworks.blob.core.windows.net/up-cebu-exchange/placeholder-img-7x5.png',
      },
    ],
    tags: ['fisherman', 'dawn', 'sea', 'traditional'],
    style: 'realism',
    rentalPlans: [
      { durationMonths: 3, price: 1800.0 },
      { durationMonths: 6, price: 3300.0 },
      { durationMonths: 12, price: 6000.0 },
    ],
    status: 'available',
    ...
    images: [
      {
        id: 6,
        isPrimary: true,
        imageUrl: 'https://unlimitedworks.blob.core.windows.net/up-cebu-exchange/placeholder-img-3x4.png',
      },
    ],
    tags: ['monsoon', 'tropical', 'storm', 'nature'],
    style: 'expressionism',
    rentalPlans: [
      { durationMonths: 3, price: 2200.0 },
      { durationMonths: 6, price: 4000.0 },
      { durationMonths: 12, price: 7300.0 },
    ],
    status: 'available',
  ...
  },
  {
    ...
    style: 'impressionism',
    rentalPlans: [
      { durationMonths: 3, price: 1000.0 },
      { durationMonths: 6, price: 1800.0 },
      { durationMonths: 12, price: 3200.0 },
    ],
    status: 'available',
  ...
  },
  {
    ...
    style: 'pop art',
    rentalPlans: [
      { durationMonths: 3, price: 1900.0 },
      { durationMonths: 6, price: 3500.0 },
      { durationMonths: 12, price: 6400.0 },
    ],
    status: 'rented',
    ...
    images: [
      {
        id: 9,
        isPrimary: true,
        imageUrl: 'https://unlimitedworks.blob.core.windows.net/up-cebu-exchange/placeholder-img-1x1.png',
      },
    ],
    tags: ['tarsier', 'wildlife', 'portrait', 'conservation'],
    style: 'realism',
    rentalPlans: [
      { durationMonths: 3, price: 800.0 },
      { durationMonths: 6, price: 1400.0 },
      { durationMonths: 12, price: 2500.0 },
    ],
    status: 'available',
    ...
    images: [
      {
        id: 10,
        isPrimary: true,
        imageUrl: 'https://unlimitedworks.blob.core.windows.net/up-cebu-exchange/placeholder-img-2x3.png',
      },
    ],
    tags: ['cordillera', 'spirits', 'ancestral', 'mystical'],
    style: 'surrealism',
    rentalPlans: [
      { durationMonths: 3, price: 3000.0 },
      { durationMonths: 6, price: 5500.0 },
      { durationMonths: 12, price: 10000.0 },
    ],
    status: 'available',
    ...
    images: [
      {
        id: 11,
        isPrimary: true,
        imageUrl: 'https://unlimitedworks.blob.core.windows.net/up-cebu-exchange/placeholder-img-5x4.png',
      },
    ],
    tags: ['boracay', 'beach', 'seascape', 'peaceful'],
    style: 'impressionism',
    rentalPlans: [
      { durationMonths: 3, price: 1400.0 },
      { durationMonths: 6, price: 2500.0 },
      { durationMonths: 12, price: 4500.0 },
    ],
    status: 'available',
  ...
  },
  {
    ...
    style: 'realism',
    rentalPlans: [
      { durationMonths: 3, price: 1700.0 },
      { durationMonths: 6, price: 3100.0 },
      { durationMonths: 12, price: 5600.0 },
    ],
    status: 'available',
  ...
  },
  {
    ...
    style: 'folk art',
    rentalPlans: [
      { durationMonths: 3, price: 1600.0 },
      { durationMonths: 6, price: 2900.0 },
      { durationMonths: 12, price: 5200.0 },
    ],
    status: 'maintenance',
  ...
  },
  {
    ...
    rentalPlans: [
      { durationMonths: 3, price: 2800.0 },
      { durationMonths: 6, price: 5100.0 },
      { durationMonths: 12, price: 9300.0 },
    ],
    status: 'available',
    ...
    images: [
      {
        id: 15,
        isPrimary: true,
        imageUrl: 'https://unlimitedworks.blob.core.windows.net/up-cebu-exchange/placeholder-img-5x7.png',
      },
    ],
    tags: ['sagada', 'caves', 'mystery', 'limestone'],
    style: 'gothic',
    rentalPlans: [
      { durationMonths: 3, price: 1300.0 },
      { durationMonths: 6, price: 2400.0 },
      { durationMonths: 12, price: 4300.0 },
    ],
    status: 'available',
