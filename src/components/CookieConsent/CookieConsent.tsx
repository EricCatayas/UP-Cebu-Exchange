...
export default function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 w-full max-w-4xl px-4 z-50">
      <div className="bg-gradient-to-tr from-[#ffa378] to-[#fbf5bc] rounded-xl shadow-2xl overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex gap-3 flex-shrink-0">
              <button
                ...
                className="px-4 py-2  hover:bg-primary-dark text-white font-medium rounded-lg transition whitespace-nowrap"
              >
                Accept
              </button>
              <button
