      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b pb-6">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="inline-flex items-center px-5 py-2.5 bg-green-600 text-white text-sm font-semibold rounded-lg hover:bg-green-700 transition-all shadow-sm active:scale-95"
          >
                ...
                {prevOrderStatus === ORDER_STATUS.CANCELLED ? (
                  <div className="p-3 bg-red-50 border border-gray-300 rounded-lg">
                    <p className="text-xs text-red-600 font-medium">
                      Order is cancelled. Status locked.
                    </p>
                  </div>
                ) : (
                  <select
