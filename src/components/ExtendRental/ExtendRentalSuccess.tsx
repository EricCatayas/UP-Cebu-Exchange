...
function ExtendRentalSuccess({ rentalOrder }: { rentalOrder: RentalOrderDTO }) {
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <div className="bg-gradient-to-r from-green-500 to-green-600 px-8 py-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-white">Rental Extension Created</h1>
                <p className="text-green-50 mt-1">Your rental extension has been successfully created!</p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="px-8 py-6 space-y-4">
            <p className="text-gray-700 text-lg">To complete your rental extension, please complete your payment.</p>

            <div className="bg-purple-50 p-6 rounded-lg border-l-4 border-purple-500 space-y-3">
              <p className="text-gray-800">
                You can complete your payment by clicking the button below or using the payment link sent to your email.
        ...
        <div className="bg-blue-50 rounded-lg border border-blue-200 p-6">
          ...
          <ul className="space-y-2 text-gray-700">
            <li className="flex items-start gap-2">
              ...
              <span>
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nulla magni at hic eius quisquam quae.
                Laudantium beatae porro in a consectetur dolorem quam eius! Necessitatibus aliquid et corrupti harum
                soluta.
              </span>
            </li>
            <li className="flex items-start gap-2">
...
export default ExtendRentalSuccess;
